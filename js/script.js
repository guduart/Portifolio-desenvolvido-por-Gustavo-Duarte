...
let LoadMorebtnWrapper = document.getElementById('btnWrapper');
let currentItem = 3;
...
loadMoreBtn.addEventListener('click', () => {
  ...
  if (currentItem >= rows.length) {
    ...
    LoadMorebtnWrapper.style.opacity = '0';
    LoadMorebtnWrapper.style.visibility = 'hidden';
    LoadMorebtnWrapper.style.pointerEvents = 'none';
  }
});
...
/*--=============== FIXING NAVIGATIONS COVERING CONTENT ON SCROLL ===============--*/
